...
*   **Material Discovery**: Property acquisition for eco-friendly, **non-fluorinated salts** (NaTCP, NaBOB), Fe-site doping (**Cr**, **Mn**), and electrode functionalization (**MTMS**) using OQMD/AFLOW APIs.
